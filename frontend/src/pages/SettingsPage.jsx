  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='rounded-xl border border-[color:var(--color-border-subtle)] bg-surface-strong p-6 shadow-lg'>
        ...
        <p className='mt-2 text-text-muted'>Sube o actualiza tu avatar. Tamaño recomendado 256x256px, máx 2MB.</p>
        <div className='mt-4 flex items-center gap-4'>
          <Avatar src={avatarUrl} name={'Usuario'} size={64} />
          <div className='flex items-center gap-2'>
            <Button onClick={() => fileInputRef.current?.click()} disabled={uploading} aria-label='Seleccionar foto'>
