...
export const ClientCreationModal = ({ isOpen, onClose }) => {
  ...
  const handleCompleteLater = () => {
    toast.success(
      `Cliente "${createdClient.name}" creado. Podrás configurar su identidad de marca más tarde.`
    );
    queryClient.invalidateQueries({ queryKey: ['clients'] });
    onClose();
      ...
      >
        ...
        <div className='fixed inset-0 overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center p-4'>
            ...
            >
              <Dialog.Panel
                className={`w-full ${step === 4 ? 'max-w-4xl' : 'max-w-xl'} rounded-2xl border border-[color:var(--color-border-subtle)] bg-[color:var(--color-surface-strong)] p-6 shadow-2xl transition-all`}
              >
                ...
                {step <= 4 && (
                  <div className='w-full mb-6'>
                    <div className='flex justify-between items-center text-[10px] uppercase font-bold tracking-widest text-[color:var(--color-text-secondary)] mb-2'>
                      ...
                      <span className='text-[color:var(--color-accent-sage)] font-mono'>
                    ...
                    <div className='h-1.5 w-full rounded-full bg-[color:var(--color-surface)] border border-[color:var(--color-border-subtle)] flex overflow-hidden'>
                      <div
                        className={`h-full bg-[color:var(--color-accent-sage)] transition-all duration-300`}
                  ...
                  {step === 1 && (
                    ...
                    >
                      ...
                      <p className='text-xs text-[color:var(--color-text-muted)] mb-5'>
                        Ingresa los datos generales del cliente para poder registrarlo y estructurar
                  ...
                  {step === 2 && (
                    ...
                    >
                      <Dialog.Title className='text-xl font-bold text-white mb-1'>
                        ¿Cómo quieres configurar la identidad de{' '}
                        <span className='text-[color:var(--color-accent-sage)]'>
                          {createdClient?.name}
                        </span>
                        ? 🧬
                      </Dialog.Title>
                      <p className='text-xs text-[color:var(--color-text-muted)]'>
                        La identidad de marca enseña a la IA el tono de voz, propuesta de valor y
                        pilares para que tus copys y calendarios sean 100% personalizados y
                        precisos.
                      </p>
                      ...
                      <div className='space-y-3 pt-2'>
                          ...
                          <div className='flex-1'>
                            <div className='flex justify-between items-center'>
                              <span className='text-sm font-bold text-white'>
                                Búsqueda Web con IA (¡Recomendado!)
                              </span>
                            ...
                            <p className='text-[11px] text-[color:var(--color-text-muted)] mt-1'>
                              Gemini investigará internet (sitio web, redes activas, noticias) y
                              completará el perfil completo en 15 segundos.
                            </p>
                          </div>
                        </button>
                        ...
                        >
                          ...
                          <div className='flex-1'>
                            <div className='flex justify-between items-center'>
                              <span className='text-sm font-bold text-white'>
                                Pegar un Brief o Apuntes libres
                              </span>
                            ...
                            <p className='text-[11px] text-[color:var(--color-text-muted)] mt-1'>
                              Pega apuntes informales de WhatsApp, notas de reuniones o un archivo
                              PDF. Gemini los procesará para estructurar la marca.
                            </p>
                          </div>
                        </button>
                        ...
                        >
                          ...
                          <div className='flex-1'>
                            ...
                            <p className='text-[11px] text-[color:var(--color-text-muted)] mt-1'>
                              Prefiero saltarme los asistentes automatizados y rellenar los datos de
                              identidad (redes, pilares, etc.) manualmente.
                            </p>
                          </div>
                        </button>
                      </div>
                      ...
                      <div className='flex flex-col items-center pt-4 border-t border-[color:var(--color-border-subtle)] mt-6'>
                        ...
                        >
                          ...
                          <span className='text-[color:var(--color-accent-sage)] font-bold group-hover:translate-x-0.5 transition-transform'>
                            Completar más tarde ➔
                          </span>
                        </button>
                      </div>
                      ...
                      {!isAiLoading && !aiPreviewData ? (
                        <>
                          <p className='text-xs text-[color:var(--color-text-muted)] mb-4'>
                            Escribe el nombre comercial exacto de la empresa para que Gemini busque
                            perfiles públicos en la web (Instagram, Sitio Web, etc.) y estruture la
                            propuesta.
                          </p>

                          <div className='space-y-4'>
                            <div className='space-y-1.5'>
                              <label className='text-xs font-bold uppercase tracking-wider text-[color:var(--color-text-muted)] block'>
                                Término de búsqueda
                              </label>
                              <input
                                type='text'
                        ...
                        <div className='py-8 flex flex-col items-center justify-center text-center space-y-6'>
                          ...
                          <div className='space-y-2'>
                            <h3 className='text-sm font-bold text-white'>
                              Gemini está investigando la marca...
                            </h3>
                            <p className='text-xs text-[color:var(--color-text-secondary)] max-w-sm'>
                              Este proceso tarda de 10 a 15 segundos porque buscamos información
                              real en internet.
                            </p>
                          </div>
                              ...
                              <div className='space-y-1'>
                                ...
                                <div className='flex flex-wrap gap-1.5 pt-1'>
                                  {aiPreviewData.content_pillars.map(tag => (
                                    <span
                                      key={tag}
                                      className='rounded bg-[#28262B] border border-[#2C2930] px-2 py-0.5 text-[10px] text-gray-300 font-semibold'
                                    >
                                      {tag}
                                    </span>
                                  ))}
                  ...
                  {step === 3.2 && (
                    ...
                    >
                      ...
                      {!isAiLoading && !aiPreviewData ? (
                        <>
                          <p className='text-xs text-[color:var(--color-text-muted)] mb-4'>
                            Pega un brief informal, tus apuntes rápidos de la primera llamada con el
                            cliente o un resumen. Gemini estructurará todo el ADN automáticamente.
                          </p>

                          <div className='space-y-4'>
                            <div className='space-y-1.5'>
                              <label className='text-xs font-bold uppercase tracking-wider text-[color:var(--color-text-muted)] block'>
                                Apuntes o Brief del Cliente
                              </label>
                              <textarea
                        ...
                        <div className='py-8 flex flex-col items-center justify-center text-center space-y-6'>
                          ...
                          <div className='space-y-2'>
                            <h3 className='text-sm font-bold text-white'>
                              Gemini está analizando tu brief...
                            </h3>
                            <p className='text-xs text-[color:var(--color-text-secondary)] max-w-sm'>
                              Estamos interpretando tus apuntes y estructurando pilares editoriales
                              y tono de voz.
                            </p>
                          </div>
                    ...
                    >
                      <div className='flex justify-between items-center pb-3 border-b border-[color:var(--color-border-subtle)]'>
                        <div>
                          ...
                          <p className='text-[11px] text-[color:var(--color-text-secondary)] mt-0.5'>
                            Revisa y perfecciona el ADN estructurado de tu cliente. Puedes cambiar
                            lo que quieras.
                          </p>
                        </div>
                      ...
                      <div className='min-h-[280px] max-h-[380px] overflow-y-auto pr-1'>
                          ...
                          <div className='space-y-4 pt-1'>
                            <div className='space-y-1.5'>
                              ...
                              <textarea
                                ...
                                onChange={e =>
                                  handleProfileFieldChange('business_description', e.target.value)
                                }
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                              <div className='space-y-1.5'>
                                ...
                                <textarea
                                  ...
                                  onChange={e =>
                                    handleProfileFieldChange('target_audience', e.target.value)
                                  }
                                  className='w-full rounded-lg border border-[color:var(--color-border-subtle)] bg-[color:var(--color-surface)] p-2.5 text-xs text-white placeholder-gray-600 focus:border-gray-500 focus:outline-none transition-all resize-none'
                              ...
                              <div className='space-y-1.5'>
                                ...
                                <textarea
                                  ...
                                  onChange={e =>
                                    handleProfileFieldChange('brand_voice', e.target.value)
                                  }
                                  className='w-full rounded-lg border border-[color:var(--color-border-subtle)] bg-[color:var(--color-surface)] p-2.5 text-xs text-white placeholder-gray-600 focus:border-gray-500 focus:outline-none transition-all resize-none'
                        ...
                        {activeRefinementTab === 'canales' && (
                          <div className='space-y-4 pt-1'>
                            <div className='space-y-2'>
                              <label className='text-xs font-bold text-[color:var(--color-text-muted)] uppercase tracking-wider block'>
                                Redes Sociales Principales
                              </label>
                              <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2'>
                                {SOCIAL_PLATFORMS.map(platform => {
                                  const isSelected = (
                                    brandProfile.preferred_platforms || []
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                              <div className='space-y-1.5'>
                                ...
                                <TagInput
                                  ...
                                  onChange={tags =>
                                    handleProfileFieldChange('preferred_formats', tags)
                                  }
                                  placeholder='Ej: Reels, Carruseles, Stories...'
                                />
                                {renderSuggestions(
                                  SUGGESTIONS.preferred_formats,
                                  'preferred_formats'
                                )}
                              </div>
                        ...
                        {activeRefinementTab === 'pilares' && (
                          <div className='space-y-4 pt-1'>
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                              <div className='space-y-1.5'>
                                ...
                                <TagInput
                                  ...
                                  onChange={tags =>
                                    handleProfileFieldChange('content_pillars', tags)
                                  }
                            ...
                            <div className='space-y-1.5'>
                              <label className='text-xs font-bold text-[color:var(--color-text-muted)] uppercase tracking-wider block'>
                                Servicios y Productos clave
                              </label>
                              <TagInput
                                tags={brandProfile.products_services || []}
                                onChange={tags =>
                                  handleProfileFieldChange('products_services', tags)
                                }
                    ...
                    >
                      ...
                      <div className='space-y-2'>
                        ...
                        <p className='text-xs text-[color:var(--color-text-muted)] max-w-sm mx-auto leading-relaxed'>
                          La identidad de marca ha sido registrada y estructurada. Gemini ya cuenta
                          con toda la información necesaria para generar ideas y calendarios
                          adaptados a su tono.
                        </p>
                        <p className='text-[11px] mt-4 text-[color:var(--color-accent-sage)] bg-[color:var(--color-accent-sage)]/5 border border-[color:var(--color-accent-sage)]/10 rounded-lg p-2.5 max-w-sm mx-auto leading-relaxed'>
                          💡 <strong>Tip Profesional:</strong> Puedes vincular sus cuentas de redes
                          sociales (Instagram, TikTok, etc.) y fotos de referencia en la Ficha de
                          Identidad para auditar y perfeccionar la consistencia de su marca con IA.
                        </p>
                      </div>
