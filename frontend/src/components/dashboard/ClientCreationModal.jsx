            ...
            >
              <Dialog.Panel className='w-full max-w-md rounded-xl border border-white/10 bg-glow-card-bg p-6 backdrop-blur-lg shadow-lg'>
                ...
                <form onSubmit={handleSubmit(submit)} className='space-y-4'>
                  ...
                  <div>
                    <label className='mb-1 block text-sm text-rambla-text-secondary'>
                      Industria (opcional)
                    </label>
                    <input
                      type='text'
                  ...
                  <div className='flex justify-end gap-2 pt-2'>
                    <button
                      type='button'
                      onClick={onClose}
                      className='rounded-md border border-rambla-border px-4 py-2 text-sm text-rambla-text-secondary hover:border-rambla-accent'
                    >
                      Cancelar
                    </button>
                    <button
