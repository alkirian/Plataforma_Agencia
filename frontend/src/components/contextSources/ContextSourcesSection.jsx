          ...
          <div className='flex items-center space-x-2 text-sm'>
            ...
            {currentStep === 'list' && (
              <div className='flex items-center space-x-2'>
                <h2 className='text-xl font-semibold text-text-primary'>📚 Fuentes de contexto</h2>
                {sources.length > 0 && (
                  <span className='text-sm text-text-muted'>para {clientName}</span>
                )}
              </div>
            )}
          </div>
