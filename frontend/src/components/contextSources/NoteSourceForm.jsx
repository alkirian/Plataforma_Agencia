    ...
    <div className='space-y-6'>
      <form onSubmit={handleSubmit} className='space-y-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          {/* Priority */}
          <div>
            <label className='block text-sm font-medium text-purple-300 mb-2'>Prioridad</label>
            <div className='space-y-2'>
              {priorities.map(priority => (
                <label key={priority.value} className='flex items-center space-x-3 cursor-pointer'>
                  ...
                  <div className='flex space-x-0.5'>{getPriorityStars(priority.value)}</div>
                </label>
              ))}
            </div>
          </div>
          ...
          {/* Category */}
          <div>
            <label className='block text-sm font-medium text-purple-300 mb-2'>Categoría</label>
            <select
        ...
        <div>
          ...
          <input
            ...
            className='w-full px-4 py-3 bg-surface-strong border border-purple-500/30 
                     ...
                     focus:ring-2 focus:ring-purple-500/50 focus:border-transparent'
          />
          <p className='mt-1 text-xs text-purple-200/50'>Separa los tags con comas</p>
        </div>
        ...
        >
          <div className='flex items-center space-x-2'>
            ...
            <div>
              ...
              <div className='flex space-x-0.5 mt-1'>{getPriorityStars(formData.priority)}</div>
            </div>
          </div>
        </motion.div>
      )}
