...
export const ClientSearchDropdown: React.FC<ClientSearchDropdownProps> = ({ onClose }) => {
      ...
      <div className='max-h-80 overflow-y-auto'>
        ...
        {!isLoading && filteredClients.length === 0 && searchTerm && (
          <div className='p-4 text-center'>
            ...
            <Button variant='primary' size='sm' className='mx-auto' onClick={handleCreateClient}>
          ...
          <div className='p-4'>
            ...
            <div className='space-y-1'>
              ...
              <Button
                ...
                className='w-full text-left justify-start p-2 text-text-muted hover:text-text-primary'
        ...
        {!isLoading && filteredClients.length > 0 && (
          <div className='py-2'>
            {filteredClients.slice(0, 8).map((client: Client) => (
              <motion.div
                key={client.id}
