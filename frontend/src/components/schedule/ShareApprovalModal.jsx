    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4'>
      ...
      >
        ...
        <div className='flex items-center justify-between border-b border-[#2C2930]/60 pb-3'>
          ...
          <button onClick={onClose} className='text-[#A19EA6] hover:text-[#F3F2F4] text-xs'>
            ✕
          </button>
        </div>
        ...
        {loading ? (
          ...
          <div className='py-6 text-center space-y-4'>
            ...
            <div>
              <p className='text-xs text-text-primary font-semibold'>
                Sin enlace de aprobación activo
              </p>
              <p className='text-[11px] text-text-muted mt-1 leading-relaxed max-w-xs mx-auto'>
                Generá un enlace único e indefinido para que tu cliente apruebe sus publicaciones o
                solicite ajustes directamente en su propio portal.
              </p>
            </div>
            <button
          ...
          <div className='space-y-4'>
            ...
            <div className='space-y-1.5'>
              <label className='block text-[10px] font-bold text-[#A19EA6] uppercase tracking-wider'>
                Enlace Compartible
              </label>
            ...
            <div className='rounded-xl bg-[#8FA89B]/10 border border-[#8FA89B]/30 px-3.5 py-3 flex items-start gap-2.5'>
              ...
              <div className='text-[11px] text-text-primary leading-relaxed'>
                <span className='font-bold'>Acceso directo indefinido</span>: Los clientes con esta
                URL podrán ver y aprobar posts programados en tiempo real. No requiere registro.
              </div>
            </div>
            ...
            <div className='pt-3 border-t border-[#2C2930]/60 flex items-center justify-between gap-4'>
              <span className='text-[10px] text-text-muted'>
                ¿Querés invalidar el enlace actual?
              </span>
              <button
                onClick={handleGenerate}
                disabled={isSubmitting}
