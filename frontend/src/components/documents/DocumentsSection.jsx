      ...
      <div className='flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between border-b border-white/10 pb-4'>
        <div>
          ...
          <p className='text-xs text-text-muted mt-1'>
            Visualiza y descarga todo el historial de imágenes, videos y piezas IA adjuntas en tu
            cronograma.
          </p>
        </div>
          ...
          <>
            ...
            >
              <div className='space-y-6'>
                ...
                <div className='bg-primary-950/20 border border-primary-500/30 rounded-xl p-4 flex items-start space-x-3'>
                  ...
                  <div className='space-y-1'>
                    ...
                    <p className='text-[11px] text-text-muted leading-relaxed'>
                      Al subir PDFs, Word o TXT con manuales de marca o briefs, la web los lee y
                      extrae su significado semántico de forma automática.
                    </p>
                    <p className='text-[11px] text-primary-300 font-semibold leading-relaxed pt-1'>
                      💡 La IA buscará automáticamente en estos documentos cada vez que le pidas
                      ideas de posts o escribas copys en el chat.
                    </p>
                  </div>
                </div>
                ...
                <div className='space-y-3'>
                  <h4 className='text-xs font-bold text-text-muted tracking-wider uppercase'>
                  ...
                  {isLoading ? (
                    ...
                    <div className='text-center py-12 border-2 border-dashed border-white/10 rounded-xl'>
                      ...
                      <p className='text-[10px] text-text-muted/60 max-w-xs mx-auto mt-1'>
                        Sube las guías de tu marca para que la IA genere ideas y copies súper
                        personalizados.
                      </p>
                    </div>
                  ) : (
