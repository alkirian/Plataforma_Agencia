...
export const DocumentCard = ({ document, columnId, index, onDelete, onDownload }) => {
  ...
  const handleDelete = async () => {
    ...
    if (
      !window.confirm(
        `¿Estás seguro de que quieres eliminar "${document?.file_name || 'este documento'}"?`
      )
    ) {
      return
    }
      ...
      <div className='flex items-start space-x-3'>
        ...
        <div className='flex-1 min-w-0'>
          <h5
            ...
            title={document?.file_name || 'Unknown file'}
          >
