...
const StatsGrid = ({ stats }) => (
  <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
    <StatItem label='Total Documents' value={stats.totalDocuments || 0} />
    <StatItem label='Total Size' value={formatFileSize(stats.totalSize || 0)} />
    <StatItem label='Pinned' value={stats.pinnedCount || 0} />
    <StatItem label='Versions' value={stats.versionCount || 0} />
  </div>
)
