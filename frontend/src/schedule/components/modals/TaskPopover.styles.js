 ...
 */
export const getAvailableThemes = () => Object.keys(TASKPOPOVER_THEMES)

/**
 * Get current theme name
 */
export const getCurrentThemeName = () => CURRENT_THEME

/**
 * Get popover container classes based on device type and docked state
 */
export const getPopoverClasses = (deviceType, isDocked = false) => {
 ...
 */
export const getAnimationVariants = (deviceType, isDocked = false) => {
 ...
 */
export const getHeaderTitleClasses = () => {
  const theme = getTheme()
 ...
 */
export const getHeaderActionsClasses = () => {
 ...
 */
export const getDockButtonClasses = () => {
  const theme = getTheme()
  return [
    'p-2',
    theme.buttonClose,
 ...
 */
export const getDeleteButtonClasses = (isDesktop = false) => {
  const theme = getTheme()
  const baseClasses = [
    theme.buttonDanger,
    BORDER_RADIUS.button,
 ...
 */
export const getDraftIndicatorClasses = (isDesktop = false) => {
  const theme = getTheme()
  const baseClasses = [
    'flex',
    'items-center',
 ...
 */
export const getDraftIndicatorDotClasses = (isDesktop = false) => {
  const theme = getTheme()
 ...
 */
export const getDraftIndicatorTextClasses = (isDesktop = false) => {
  const theme = getTheme()
 ...
 */
export const getDesktopDeleteContainerClasses = () => {
 ...
 */
export const getPointerClasses = () => {
  const theme = getTheme()
  return [
    'absolute',
    'w-3',
