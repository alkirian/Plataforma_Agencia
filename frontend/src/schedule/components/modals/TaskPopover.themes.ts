...
export const TASKPOPOVER_THEMES: Record<ThemeName, ThemeConfig> = {
...
export const applyTheme = (themeName: string): ThemeConfig => {
  if (TASKPOPOVER_THEMES[themeName as ThemeName]) {
    ...
    return TASKPOPOVER_THEMES[themeName as ThemeName]
  }
...
export const getThemeByName = (themeName: string): ThemeConfig => {
  return TASKPOPOVER_THEMES[themeName as ThemeName] || TASKPOPOVER_THEMES['dark-modern']
}
